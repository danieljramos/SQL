...
-- 06 Write a query to find employees whose manager has a higher salary than the average salary of all managers.

Select emp_no as employee from salaries where 

-- 07 How would you use a window function to rank emp by their total salary within each salary employee?
